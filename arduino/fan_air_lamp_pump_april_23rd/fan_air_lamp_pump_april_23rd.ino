...
//print Date on LCD display
 ...
 if( (Hor == 9 || Hor == 15 || Hor== 18) && (Min >  6 && Min < 8)) //Comparing the current time with the Alarm time
      {
 ...
 if( (Hor == 9) && (Min >  2 && Min < 4 )) //Comparing the current time with the Alarm time
      {
...
//set time for the air: 3x per day for 10min
  ...
  if( (Hor == 18 || Hor==14 || Hor == 7 || Hor == 22) &&  (Min > 0  && Min < 5 ) ) 
      {
