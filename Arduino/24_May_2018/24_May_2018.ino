...
#error "Uncomment the #define for either USE_WIFI101_SHIELD or USE_ETHERNET_SHIELD"
    ...
    // Use WiFi
      ...
      #include <WiFi101.h>
    #endif
//    char ssid[] = "Redmi Jana";    //  your network SSID (name)
//    char pass[] = "Kalinov994:)";   // your network password

   
    char ssid[] = "AndroidAP";    //  your network SSID (name)
    char pass[] = "sguy3790";   // your network password
...
unsigned long weatherStationChannelNumber = 483297;
unsigned int temperatureFieldNumber = 1;
const char * readAPIKey = "IMSWZX7BOCRP64UM";
...
void loop() {
  ...
  float temperatureInF = ThingSpeak.readFloatField(weatherStationChannelNumber, temperatureFieldNumber, readAPIKey);

  Serial.print("Current temp is: ");
  Serial.print(temperatureInF);
  Serial.println(" degrees F");

  delay(1000); // Note that the weather station only updates once a minute
}
