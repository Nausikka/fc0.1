...
// set time for fan: twice per day for 2 minute
 if( (Hor == 18 || Hor == 10 || Hor == 16) && (Min >  29 && Min < 31)) //Comparing the current time with the Alarm time
     {
 ...
 if( (Hor == 8 ) && (Min >  30 && Min < 32 )) //Comparing the current time with the Alarm time
      {
...
//set time for the air                                  
  ...
  if( (Hor == 13 || Hor == 11 || Hor == 17) &&  (Min > 40  && Min < 45 ) ) 
      {
